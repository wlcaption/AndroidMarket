...
/**
 * Author: ZhuWenWu Version V1.0 Date: 14-3-16 下午3:11 Description: Modification History: Date Author Version Discription
 * ----------------------------------------------------------------------------------- 14-3-16 ZhuWenWu 1.0 1.0 Why &
 * What is modified:
 */
public class DownloadManager {
	...
	protected void resumeDownload(DownloadInfo downloadInfo, final RequestCallBack<File> callback) throws DbException {
		HttpUtils http = new HttpUtils();
		http.configRequestThreadPoolSize(maxDownloadThread);
	...
	protected void removeDownload(DownloadInfo downloadInfo) throws DbException {
	...
	protected void stopDownload(DownloadInfo downloadInfo) throws DbException {
		HttpHandler<File> handler = downloadInfo.getHandler();
		if (handler != null && !handler.isStopped()) {
			handler.stop();
		} else {
