...
public class DownloadActivity extends ActivityGroup {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		Intent i1 = new Intent(context, Download1Activity.class);
		listViews.add(getView("A", i1));
		Intent i2 = new Intent(context, Download2Activity.class);
		listViews.add(getView("B", i2));
		Intent i3 = new Intent(context, Download3Activity.class);
